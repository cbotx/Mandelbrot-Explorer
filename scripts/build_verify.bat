...
cl /nologo /O2 /EHsc /openmp /std:c++17 /arch:AVX2 /MT /DMANDEL_ENABLE_ASMJIT ^
   ...
   /Fo:build\ ^
   src\tools\verify.cpp src\gui\mandel_navigator.cpp src\gui\navigator.cpp src\gui\orbit_overlay.cpp src\gui\gui_color.cpp ^
   src\engine\compute_backend.cpp src\engine\compute_backend_d3d11.cpp src\engine\mandel_perturbation.cpp src\engine\mandel_expression.cpp src\engine\float_math.cpp src\engine\formula_expression.cpp src\engine\formula_expression_orbit.cpp src\engine\formula_expression_jit.cpp src\engine\formula_expression_oracle.cpp src\engine\interpolate.cpp src\engine\color.cpp ^
   /Fe:build\verify.exe ^
