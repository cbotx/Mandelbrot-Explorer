...
cl /nologo /O2 /EHsc /openmp /std:c++17 /arch:AVX2 /MT /DMANDEL_ENABLE_ASMJIT ^
   ...
   /Fo:build\ ^
   src\gui\win32_main.cpp src\gui\gui_color.cpp src\gui\gui_theme.cpp src\gui\gui_export.cpp src\gui\ui_framework.cpp src\gui\formula_editor_panel.cpp src\gui\mandel_navigator.cpp src\gui\navigator.cpp src\gui\orbit_overlay.cpp ^
   ...
   asmjit.lib gmp.lib d3d11.lib dxgi.lib d3dcompiler.lib user32.lib gdi32.lib comctl32.lib comdlg32.lib windowscodecs.lib ole32.lib || goto :err
